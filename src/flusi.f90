program FLUSI
  ...
  subroutine Start_Simulation()
    ...
    if (equation=='navier-stokes' .or. equation=='navier-stokes-SS') neq = nd ! 3 fields (velocity)
    ...
    nrw = 1
    if (equation=="navier-stokes-SS") nrw = 3
    ...
    if (equation=="navier-stokes-SS") ncw = 3
...
subroutine initialize_time_series_files()
    ...
    "enst_f","enst_x_f","enst_y_f","enst_z_f",&
    "enst_tot","enst_tot_x","enst_tot_y","enst_tot_z"
    close (14)

    open  (14,file='umag.t',status='replace')
    write (14,'(3(A15,1x))') "%          time","u_max","u_min"
    close (14)

    open  (14,file='vortmag.t',status='replace')
    write (14,'(3(A15,1x))') "%          time","vort_max","vort_min"
    close (14)
    ...
    if (iSaveSpectrae==1) then
      ...
      close (14)
      open  (14,file='spectrum_tot.t',status='replace')
      write (14,'(2(A15,1x))') "%          time","Etot_k"
      close (14)

      open  (14,file='spectrum_x.t',status='replace')
      write (14,'(2(A15,1x))') "%          time","Ex_k"
      close (14)
      open  (14,file='spectrum_y.t',status='replace')
      write (14,'(2(A15,1x))') "%          time","Ey_k"
      close (14)
      open  (14,file='spectrum_z.t',status='replace')
      write (14,'(2(A15,1x))') "%          time","Ez_k"
      close (14)
    endif
